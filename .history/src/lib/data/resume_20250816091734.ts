	...
	education: [
		{
			...
			logoUrl: "https://upload.wikimedia.org/wikipedia/en/9/98/Dr._A.P.J._Abdul_Kalam_Technical_University_logo.png",
			start: '2022',
			end: '2025'
		},
		{
			...
			logoUrl: "https://jecschools.com/frontend/web/uploads/media//2023/Dec/30/1703953313_Bhai_Parmanand_Vidya_Mandir__Anand_Vihar.jpg",
			start: '2016',
			end: '2021'
		},
		{
			...
			logoUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgc6H4Rt1HBn-cZK0TjehO8J-hFPEkAfc_eA&s",
			start: '2012',
			end: '2018'
		}
	],
...
projects: [
  {
    ...
    active: true,
    description:
      'Co-founded and developed an AI-powered automated audit platform adopted by 20+ audit firms including Big 4. Reduced costs by 63% and improved efficiency by 50%. Scaled platform to $15M valuation by optimizing backend performance, enhancing UI/UX, and ensuring sub-3s load times.',
    technologies: [
      'Next.js',
      'Typescript',
      'Node.js',
  ...
  },
  {
    ...
    active: false,
    description:
      'Built and deployed AI-driven web products integrating advanced ML models into production. Collaborated with cross-functional teams to deliver intuitive, user-centric designs and seamless AI feature integration.',
    technologies: [
      'React',
      'Next.js',
      'Typescript',
  ...
  },
  {
    ...
    active: false,
    description:
      'Developed a multilingual AI platform capable of translating 196 languages from images and PDFs while preserving formatting. Designed and trained custom MT5 transformer models using Hugging Face datasets. Delivered human-like translation accuracy for enterprise clients.',
    technologies: [
      'Python',
      'TensorFlow',
      'PyTorch',
