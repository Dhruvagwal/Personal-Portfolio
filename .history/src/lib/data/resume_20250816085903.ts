...
export let DATA = {
	...
	summary: `
	I began my journey in 2020, diving deep into software development and entrepreneurship. Over the years, I’ve built and launched multiple products, learning to take ideas from concept to execution. In 2022, I shifted my focus entirely to scaling SaaS and AI-driven solutions, co-founding Sheetsway, an AI-powered audit automation platform that gained recognition from top global audit firms and government stakeholders.

Along the way, I’ve honed my skills across full-stack development, AI/ML, and cloud technologies, while also building strong foundations in business strategy and product development. My experience includes competing in and winning hackathons, working on collaborative projects, and continuously experimenting with new technologies.

I bring a unique mix of technical expertise, problem-solving, and entrepreneurial drive, making me well-prepared to deliver impactful solutions in fast-moving environments.
	`,
