...
export let DATA = {
	...
	projects: [
		...
		},
		{
			...
			technologies: ['Python', 'TensorFlow', 'PyTorch', 'React', 'Next.js', 'WebRTC', 'Node.js'],
			links: [],
			image: 'https://vaibhav-portfolio-c9f3e.web.app/_next/static/media/onelang-demoi.7f70fc8c.png',
			video: 'https://firebasestorage.googleapis.com/v0/b/onelangworld.appspot.com/o/Onelang.34a6c092.mp4?alt=media&token=990e5e19-ed75-46ac-ac0d-b25ab2c493a5'
		},
		{
			title: 'AI Avatar Interaction (Hackathon Project)',
			href: '',
